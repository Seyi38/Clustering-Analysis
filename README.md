# Clustering-Analysis
The objective of this task is to provide insights into the socioeconomic and health factors of the countries in the dataset and segment countries based on these factors.
